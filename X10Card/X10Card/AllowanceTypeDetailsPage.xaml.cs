...
namespace X10Card
{
    ...
    public partial class AllowanceTypeDetailsPage : ContentPage
    {
        ...
        AllowanceTransactionsDatabase allowanceTransactionsDatabase;
        List<AllowanceTransactions> allowanceTransactionslist;
        List<AllowanceTransactions> finacyrlist;
        ...
        private void listview_allowancetypedetails_ItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            string MonthYY = currentRecord.MonthYY.ToString();
