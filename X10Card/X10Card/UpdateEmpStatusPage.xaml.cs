...
namespace X10Card
{
    ...
    public partial class UpdateEmpStatusPage : ContentPage
    {
        ...
        EmploymentStatusDatabase employmentStatusDatabase;
        List<EmploymentStatus> employmentStatuslist;
        SubEmploymentStatusDatabase subEmploymentStatusDatabase;
        ...
        private async void btn_updatestatus_Clicked(object sender, EventArgs e)
        {
            ...
            if (await checkvalidation())
            {
                ...
                await App.UpdateEmployementstatus(Registration_No, EmploymentStatusCode, EmploymentSectorCode, EmploymenttypeCode);
